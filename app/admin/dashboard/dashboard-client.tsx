...
import type { RecentTransactionItem } from "@/lib/db/data-access/admin";
import {
  Users,
  CreditCard,
  FileText,
...
export function AdminDashboardClient({
  ...
  const { data: metrics, isLoading: metricsLoading } = useQuery({
    ...
    queryFn: async () => {
      const { getAdminDashboardMetricsAction } = await import(
        "@/app/actions/admin"
      );
  ...
  const { data: transactions, isLoading: transactionsLoading } = useQuery({
    ...
    queryFn: async () => {
      const { getAdminRecentTransactionsAction } = await import(
        "@/app/actions/admin"
      );
  ...
  if (!mounted || (metricsLoading && !metrics)) {
    return (
          ...
          <div className="rounded-lg border bg-card shadow-sm">
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {transactions.map((transaction: RecentTransactionItem) => (
