    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2 group">
            <div className="w-10 h-10 bg-gold-500 rounded-xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-gold-500/30">
                <span className="font-bold text-white text-2xl font-sans">I</span>
            </div>
        ...
        <div className="hidden md:flex items-center">
            <a href="#pricing" className="relative inline-flex items-center justify-center px-6 py-2.5 overflow-hidden font-bold tracking-tight text-white transition-all duration-300 bg-black rounded-full hover:bg-stone-800 hover:shadow-lg hover:-translate-y-0.5 group">
                <span className="relative flex items-center gap-2">
                    Cobain Gratis <ArrowRight size={16} className="text-gold-400 group-hover:translate-x-1 transition-transform" />
                </span>
            </a>
        </div>
