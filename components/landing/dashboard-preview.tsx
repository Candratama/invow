  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div
          className="absolute top-20 right-4 md:right-[30%] z-30 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 flex items-center gap-3 max-w-[280px] animate-pop-in"
            ...
            <div className="w-full h-full bg-stone-50 rounded-[3rem] overflow-hidden relative flex flex-col">
              ...
              <div className="flex-1 overflow-hidden relative flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-4 pb-20 space-y-4 scrollbar-hide">
                  {/* Main Card */}
                  <div
                    className="p-4 rounded-2xl bg-gold-500 text-white shadow-xl shadow-gold-500/20 relative overflow-hidden animate-pop-in"
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div
                          key={i}
                          className="p-2.5 rounded-xl bg-white border border-stone-100 shadow-sm flex items-center justify-between group hover:border-gold-200 transition-colors animate-slide-right"
